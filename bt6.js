...
// console.log(sum)
//
// let newarr10 = newarr.map(function (value, index)
// {
//     return (value += 10)
// })
//
...
// console.log(narr);
//
// for (let ii = 0; ii <= arr.length - 1; ii += n) //2 vòng for ko lồng trong nhau ko cần thiết phải đặt tên biên chạy khác nhau
// {
...
// let arrdup = arr.filter(function (value, index)
// {
