...
//   console.log("N phai la so tu nhien >1");
// } else {
...
//   }
// }
// console.log(snt); // B nên cho in kết quả vào nhánh else để tránh in "true" mặc dù ko thỏa mãn điều kiện
...
// let b = 0;
// let c;
// for (let n = Number(prompt("nhap n")) - 1; n >= 0; n--) {
//   c = a;
//   a = a + b;
//   b = c;
// }
...
// // B check lại thuật toán giải nhé, mình test thử thấy kết quả không đúng
...
//   console.log(`x co vo so nghiem
// y co vo so nghiem`);
// } else if (a - a1 == 0 && b - b1 == 0 && c - c1 !== 0) {
